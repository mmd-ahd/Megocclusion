...
for sub in sub_ids:
    ...
    for level in EVENT_ID_MAP.keys():
        epochs_fname = os.path.join(sub_epochs_dir, f'{sub_bids_id}_task-objectrecognition_occlusion-{level}_meg-epo.fif')
    ...
    for level, epochs in zip(EVENT_ID_MAP.keys(), all_epochs_list):
